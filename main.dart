                            ...
                            children: [
                              ...
                              CircleAvatar(
                                ...
                                backgroundImage: AssetImage(
                                    "assets/images/profiletayyip.jpg"),
                              ),
                            ],
                          ),
                        ],
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          MusicRow("assets/images/cover1.jpg",
                              "İstanbul'da Sonbahar", "Teoman"),
                          MusicRow("assets/images/cover2.jpg", "Biliyorsun",
                              "Sezen Aksu"),
                          MusicRow("assets/images/cover3.jpg",
                              "Bir Ömür Yetmez", "Müslüm Gürses"),
                          MusicRow("assets/images/cover4.jpg", "Islak Islak",
                              "Bariş Akarsu"),
                          MusicRow("assets/images/cover5.jpg", "Yolcu",
                              "Neşet Ertaş"),
                          MusicRow("assets/images/cover6.jpg", "Başima Bela",
                              "Serdar Ortaç"),
                          MusicRow("assets/images/cover7.jpg", "öp", "Tarkan"),
                          MusicRow("assets/images/cover8.jpg", "Vazgeçtim",
                              "Yildiz Tilbe"),
                          SizedBox(
                            height: 20,
                          ),
                            ...
                            child: Row(
                              children: [
                                ...
                                MusicRow2("assets/images/cover4.jpg",
                                    "Islak Islak", "Bariş Akarsu"),
                                MusicRow2("assets/images/cover5.jpg", "Yolcu",
                                    "Neşet Ertaş"),
                                MusicRow2("assets/images/cover6.jpg",
                                    "Başima Bela", "Serdar Ortaç"),
                                MusicRow2(
                                    "assets/images/cover7.jpg", "öp", "Tarkan"),
                                MusicRow2("assets/images/cover3.jpg",
